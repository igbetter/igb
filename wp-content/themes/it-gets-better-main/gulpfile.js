...
// File paths
const files = {
	scssPath: 'theme/_assets/scss/**/*.scss',
	jsPath: 'theme/_assets/js/src_scripts/*.js',
	imgPath: 'theme/_assets/images/**/*.{png,jpg,gif,svg,webp}',
	svgPath: 'theme/_assets/svg/originals/*.svg',
	phpPath: '*.php',
	nestedPhpPath: '**/*.php',
};
...
function scriptsTask() {
	return src(
		...
		.pipe(terser())
		.pipe(dest('theme/_assets/js', { sourcemaps: '.' }));
}
...
function svgsTask(){
	...
	return src( 'theme/_assets/svg/originals/*.svg' )

		.pipe( svgSprite( config ) )
		.pipe( dest( 'theme/_assets/svg' ) );
}

function browsersyncServe(cb){
  browsersync.init({
	proxy: "http://igb-new.local"
  });
  cb();
}
